...
export const SidebarProvider = ({
  ...
  // Inisialisasi openState berdasarkan ukuran layar
  ...
  // Listener untuk mengubah state open saat ukuran layar berubah
  useEffect(() => {
    const handleResize = () => {
    ...
    // Panggil sekali saat mount untuk memastikan nilai awal
    handleResize();
