...
const HeroRoot: React.FC = () => {
  return (
    <section className="flex min-h-screen w-screen flex-col items-center justify-center">
      ...
      <div className="animate-glow hidden h-px w-screen animate-fade-left bg-linear-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0 md:block" />

      <h1 className="text-edge-outline font-display z-10 animate-title cursor-default whitespace-nowrap bg-white bg-linear-to-b from-neutral-50 to-neutral-400 bg-clip-text px-0.5 py-3.5 text-4xl font-bold text-transparent duration-3s sm:text-6xl md:text-9xl">
        Arcalis Ai
      </h1>

      <div className="animate-glow hidden h-px w-screen animate-fade-right bg-linear-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0 md:block" />
